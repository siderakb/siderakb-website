...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1</td>
      <td>
        Include <a href="#main-pcbs">electronic parts</a> and{" "}
        <a href="https://github.com/siderakb/ergo-snm-keyboard/tree/main/ErgoSNM_Keyboard/rev2/left">
          PCB
        </a>
      </td>
      <td rowspan="10">
        <a href="https://github.com/siderakb/ergo-snm-keyboard/releases/tag/v2.1.0">
          GH Release Page
        </a>{" "}
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Include <a href="#main-pcbs">electronic parts</a> and{" "}
        <a href="https://github.com/siderakb/ergo-snm-keyboard/tree/main/ErgoSNM_Keyboard/rev2/right">
          PCB
        </a>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Include{" "}
        <a href="https://github.com/siderakb/pmw3360-pcb/tree/v3.1.0#bom">electronic parts</a> and{" "}
        <a href="https://github.com/siderakb/pmw3360-pcb/tree/v3.1.0/PMW3360_PCB">PCB</a>
      </td>
      <td>
        <a href="https://github.com/siderakb/pmw3360-pcb/releases/tag/v3.1.0">GH Release Page</a>
      </td>
    </tr>
    <tr>
      ...
      <td></td>
      <td>
        <a href="https://www.aliexpress.com/i/1005001632971456.html">Ref</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="https://us.misumi-ec.com/vona2/detail/110300427030/?HissuCode=BCHJJ7">Ref1</a>,{" "}
        <a href="https://www.aliexpress.com/item/1005003081021713.html">Ref2</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="https://a.co/d/9SjkIcC">Ref</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="https://www.ebay.com/itm/155455713493?mkcid=16&mkevt=1&mkrid=711-127632-2357-0&ssspo=8fby7xizq9e&sssrc=2047675&ssuid=&widget_ver=artemis&media=COPY">
          Ref
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="https://www.aliexpress.com/item/4000585933306.html">Ref</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="https://www.aliexpress.com/item/1005004543081525.html">Ref</a>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>For feet</td>
      <td>
        <a href="https://www.aliexpress.com/item/4000226223259.html">Ref</a>
      </td>
    </tr>
  </tbody>
</table>
...
| Qty | Value                | Footprint                              | Designator      | JLCPCB#  | MFR. Part#      | Basic Parts _(1)_ |
| --- | -------------------- | -------------------------------------- | --------------- | -------- | --------------- | :---------------: |
...
| 2   | USB Type-C 16P _(2)_ | HRO TYPE-C-31-M-12                     | J1,J2           | C165948  | TYPE-C-31-M-12  |        ❌         |
| 1   | 3.5mm TRRS 8P _(2)_  | PJ-393 8P TRRS                         | J3              | C668609  | PJ-393 8PJ      |        ❌         |
| 1   | Conn 01x08           | 0.5mm Pitch 8P FPC/FFC Connector _(3)_ | J4              | C2856797 | FPC-05F-8PH20   |        ❌         |

1. _Basic Part_ means no additional manual feeding charge for these parts when using JLCPCB's PCBA services. Parts that are not _Basic_ are _Extended_.
...
3. For `v2.0`, `J4` is JST GH1.25 8P connector (Mfr. Part No: _SM08B-GHS-TB(LF)(SN)_), please refer to the schematic for wiring sequence.
4. If you want to save some money, you can consider not using PCBA service soldering `U1`, `F1` and `J1`\~`J4` (all are _Extended_ parts), there parts are not very difficult to solder by soldering iron, and cheap to buy separately.
...
| 6   | Switch _(1)_  | Cherry MX style hot-swap socket        | KEY1~KEY6  | C2803348 | CPG151101S11  |     ❌      |
| 1   | Conn 01x08    | 0.5mm Pitch 8P FPC/FFC Connector _(2)_ | J1         | C2856797 | FPC-05F-8PH20 |     ❌      |
| 1   | Encoder _(1)_ | Alps EC11E-Switch Vertical             | EC1        | --       | --            |     --      |
...
2. For `v2.0`, `J1` is JST GH1.25 8P connector (Mfr. Part No: _SM08B-GHS-TB(LF)(SN)_), please refer to the schematic for wiring sequence.
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/1BXKdrCFn6c?si=8W46tsbZs7Ltttud"
...
If you are not very familiar with soldering, please read the [Soldering Guide](/guides/soldering) first.
...
<Tabs>
  <TabItem value="uf2" label="UF2 file" default>
    <ol>
      ...
      <li><a href="/guides/bt-dfu/#raspberry-pi-rp2040">Enter DFU mode</a>.</li>
...
4. Build via command `make siderakb/ergosnm/rev2:vial`. You may need to additionally install _make_.
...
:::
  ...
  <TabItem value="cli" label="CLI">
    <ol>
      ...
      <li><a href="/guides/bt-dfu/#raspberry-pi-rp2040">Enter DFU mode</a>. If you have other keyboards, you can also enter DFU mode before executing the command (a keyboard in DFU mode will not be able to type).</li>
    </ol>
  </TabItem>
</Tabs>
...
:::info
For more information, please refer to [QMK: Flashing Firmware](https://docs.qmk.fm/#/newbs_flashing) and [QMK: Raspberry Pi RP2040 UF2](https://docs.qmk.fm/#/flashing?id=raspberry-pi-rp2040-uf2).
:::
...
You can use a site like [this](https://en.key-test.ru/) or [this](https://keytest.vn/) to test the keyboard. Sine the switch may not be installed on keyboard at present, you can use tweezers to act as a switch.
