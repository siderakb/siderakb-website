...
| [Pro Micro][pro-micro] boards | 3.3V/8MHz (recommended)              | 2   | Or compatible boards, e.g.  [Elite-C][elite-c], [Next μ][next-u], [RP Micro][rp-micro], [nRFMicro][nrf-micro] or [MDBTMicro][mdbt-micro]. |
...
If you want the Pro Micro removable, then solder the pin sockets on the PCB, so that the Pro Micro can be plugged in. If you don't need it to be removable, you can also just solder it to the PCB with pin headers.

### 3. Plug in Pro Micro Board

Plug the Pro Micro into the PCB.

The pin sockets of `Rev 1.0` is 1*13 pins, one more pin than Pro Micro, this is reserved for the battery pins of the board with charging circuit such as [nRFMicro][nrf-micro] or [MDBTMicro][mdbt-micro].
...
[next-u]: https://github.com/ziteh/next-micro
[rp-micro]: https://github.com/ziteh/rp-micro
[nrf-micro]: https://github.com/joric/nrfmicro
[mdbt-micro]: https://github.com/ziteh/mdbt-micro
